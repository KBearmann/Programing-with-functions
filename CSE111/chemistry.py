...
def make_periodic_table():
    """Create and return a dictionary containing data for all 94 naturally occurring elements."""
    periodic_table_dict = {
        "Ac": ["Actinium", 227],
        "Ag": ["Silver", 107.8682],
...
def main():
    """Main function to call make_periodic_table and compute molar mass."""
    # Get a chemical formula for a molecule
    formula = input("Enter the molecular formula of the sample: ")

    # Get the mass of a chemical sample in grams
    mass_in_grams = float(input("Enter the mass in grams of the sample: "))

    #Periodic table in a variable.
    periodic_table_dict = make_periodic_table()

    #Function to convert the chemical formula given 
    symbol_quantity_list = parse_formula(formula)

    # Function to compute the molar mass of the molecule from the compound list.
